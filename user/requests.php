                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo($deliverable)?></span>
                                        ...
                                        echo"
                                            ...
                                            <td>';
                                                    ...
                                                    elseif($status == 2){
                                                        ...
                                                        echo "<a href='#' class='send_request btn btn-primary btn-icon-split ' data-toggle='modal' data-target='#request_model'>Aprove Request</a>
                                                        <input type='hidden' name='text' class= 'idx' value='$index'>";
                                                    };
                                        echo'    
                                            </td>';
