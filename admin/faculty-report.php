        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-chart-pie"></i> Reports</h1>
                                 ...
                                 <div class="card">
                                    <div class="card-body">
                                       <div class="chart-title">
                                          <h4>Faculty Clearance Report</h4>
                                       </div>
   ...
   <script>
       window.onload = function () {
           ...
           var chart = new CanvasJS.Chart("chartContainer", {
               ...
               title: {
                   text: "Percentage of Completed vs Incomplete"
               },
               data: [{
                   type: "pie",
                   ...
                   click: explodePie,
                   dataPoints: [
                       { y: 60, label: "Completed" },
                       { y: 40, label: "Incomplete" }
                   ]
               }]
           });
           chart.render();
