                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>Maecenas dapibus dignissim nunc, vitae hendrerit metus blandit vel.</td>
                                            <td><a href="#" class="btn btn-danger btn-icon-split float-right">
                                                <span class="icon text-white-50">
                                                    <i class="fas fa-file-word"></i>
                                                </span>
                                                <span class="text">File</span>
                                            </a></td>
                                            <td><i class="fas fa-fw fa-paper-plane"></i> | <i class="fas fa-fw fa-edit"></i> | <i class="fas fa-fw fa-trash"></i></td>
                                        </tr>
                                        <tr>
                                            <td>Requirements 101</td>
                                            ...
                                            <td><span class="badge bg-success text-white">cleared</span></td>
                                            <td>Maecenas dapibus dignissim nunc, vitae hendrerit metus blandit vel.</td>
                                            <td><a href="#" class="btn btn-warning btn-icon-split float-right">
                                                <span class="icon text-white-50">
                                                    <i class="fas fa-file-word"></i>
                                                </span>
                                                <span class="text">File</span>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-success text-white">cleared</span></td>
                                            <td>Maecenas dapibus dignissim nunc, vitae hendrerit metus blandit vel.</td>
                                            <td><a href="#" class="btn btn-success btn-icon-split float-right">
                                                <span class="icon text-white-50">
                                                    <i class="fas fa-file-word"></i>
                                                </span>
                                                <span class="text">File</span>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-danger text-white">not cleared</span></td>
                                            <td>Maecenas dapibus dignissim nunc, vitae hendrerit metus blandit vel.</td>
                                            <td><a href="#" class="btn btn-info btn-icon-split float-right">
                                                <span class="icon text-white-50">
                                                    <i class="fas fa-file-word"></i>
                                                </span>
                                                <span class="text">File</span>
